...
value ocaml_gpiod_is_gpiochip_device(value path) {
	return Val_bool(gpiod_is_gpiochip_device(((const char *) ptr_of_val(path))));
}

value ocaml_gpiod_chip_open(value path) {
	return val_of_ptr((void *)gpiod_chip_open(((const char *) ptr_of_val(path))));
}
...
value ocaml_gpiod_chip_get_name(value chip) {
	return val_of_ptr((void *)gpiod_chip_get_name(((struct gpiod_chip *) ptr_of_val(chip))));
}

value ocaml_gpiod_chip_get_label(value chip) {
	return val_of_ptr((void *)gpiod_chip_get_label(((struct gpiod_chip *) ptr_of_val(chip))));
}
...
value ocaml_gpiod_chip_find_line(value chip, value name) {
	return Val_int(gpiod_chip_find_line(((struct gpiod_chip *) ptr_of_val(chip)), ((const char *) ptr_of_val(name))));
}
...
value ocaml_gpiod_line_name(value line) {
	return val_of_ptr((void *)gpiod_line_name(((struct gpiod_line *) ptr_of_val(line))));
}

value ocaml_gpiod_line_consumer(value line) {
	return val_of_ptr((void *)gpiod_line_consumer(((struct gpiod_line *) ptr_of_val(line))));
}
...
value ocaml_gpiod_line_request_input(value line, value consumer) {
	return Val_int(gpiod_line_request_input(((struct gpiod_line *) ptr_of_val(line)), ((const char *) ptr_of_val(consumer))));
}

value ocaml_gpiod_line_request_output(value line, value consumer, value default_val) {
	return Val_int(gpiod_line_request_output(((struct gpiod_line *) ptr_of_val(line)), ((const char *) ptr_of_val(consumer)), Int_val(default_val)));
}

value ocaml_gpiod_line_request_rising_edge_events(value line, value consumer) {
	return Val_int(gpiod_line_request_rising_edge_events(((struct gpiod_line *) ptr_of_val(line)), ((const char *) ptr_of_val(consumer))));
}

value ocaml_gpiod_line_request_falling_edge_events(value line, value consumer) {
	return Val_int(gpiod_line_request_falling_edge_events(((struct gpiod_line *) ptr_of_val(line)), ((const char *) ptr_of_val(consumer))));
}

value ocaml_gpiod_line_request_both_edges_events(value line, value consumer) {
	return Val_int(gpiod_line_request_both_edges_events(((struct gpiod_line *) ptr_of_val(line)), ((const char *) ptr_of_val(consumer))));
}

value ocaml_gpiod_line_request_input_flags(value line, value consumer, value flags) {
	return Val_int(gpiod_line_request_input_flags(((struct gpiod_line *) ptr_of_val(line)), ((const char *) ptr_of_val(consumer)), Int_val(flags)));
}

value ocaml_gpiod_line_request_output_flags(value line, value consumer, value flags, value default_val) {
	return Val_int(gpiod_line_request_output_flags(((struct gpiod_line *) ptr_of_val(line)), ((const char *) ptr_of_val(consumer)), Int_val(flags), Int_val(default_val)));
}

value ocaml_gpiod_line_request_rising_edge_events_flags(value line, value consumer, value flags) {
	return Val_int(gpiod_line_request_rising_edge_events_flags(((struct gpiod_line *) ptr_of_val(line)), ((const char *) ptr_of_val(consumer)), Int_val(flags)));
}

value ocaml_gpiod_line_request_falling_edge_events_flags(value line, value consumer, value flags) {
	return Val_int(gpiod_line_request_falling_edge_events_flags(((struct gpiod_line *) ptr_of_val(line)), ((const char *) ptr_of_val(consumer)), Int_val(flags)));
}

value ocaml_gpiod_line_request_both_edges_events_flags(value line, value consumer, value flags) {
	return Val_int(gpiod_line_request_both_edges_events_flags(((struct gpiod_line *) ptr_of_val(line)), ((const char *) ptr_of_val(consumer)), Int_val(flags)));
}
...
value ocaml_gpiod_line_request_bulk_input(value bulk, value consumer) {
	return Val_int(gpiod_line_request_bulk_input(((struct gpiod_line_bulk *) ptr_of_val(bulk)), ((const char *) ptr_of_val(consumer))));
}

value ocaml_gpiod_line_request_bulk_output(value bulk, value consumer, value default_vals) {
	return Val_int(gpiod_line_request_bulk_output(((struct gpiod_line_bulk *) ptr_of_val(bulk)), ((const char *) ptr_of_val(consumer)), ((const int *) ptr_of_val(default_vals))));
}

value ocaml_gpiod_line_request_bulk_rising_edge_events(value bulk, value consumer) {
	return Val_int(gpiod_line_request_bulk_rising_edge_events(((struct gpiod_line_bulk *) ptr_of_val(bulk)), ((const char *) ptr_of_val(consumer))));
}

value ocaml_gpiod_line_request_bulk_falling_edge_events(value bulk, value consumer) {
	return Val_int(gpiod_line_request_bulk_falling_edge_events(((struct gpiod_line_bulk *) ptr_of_val(bulk)), ((const char *) ptr_of_val(consumer))));
}

value ocaml_gpiod_line_request_bulk_both_edges_events(value bulk, value consumer) {
	return Val_int(gpiod_line_request_bulk_both_edges_events(((struct gpiod_line_bulk *) ptr_of_val(bulk)), ((const char *) ptr_of_val(consumer))));
}

value ocaml_gpiod_line_request_bulk_input_flags(value bulk, value consumer, value flags) {
	return Val_int(gpiod_line_request_bulk_input_flags(((struct gpiod_line_bulk *) ptr_of_val(bulk)), ((const char *) ptr_of_val(consumer)), Int_val(flags)));
}

value ocaml_gpiod_line_request_bulk_output_flags(value bulk, value consumer, value flags, value default_vals) {
	return Val_int(gpiod_line_request_bulk_output_flags(((struct gpiod_line_bulk *) ptr_of_val(bulk)), ((const char *) ptr_of_val(consumer)), Int_val(flags), ((const int *) ptr_of_val(default_vals))));
}

value ocaml_gpiod_line_request_bulk_rising_edge_events_flags(value bulk, value consumer, value flags) {
	return Val_int(gpiod_line_request_bulk_rising_edge_events_flags(((struct gpiod_line_bulk *) ptr_of_val(bulk)), ((const char *) ptr_of_val(consumer)), Int_val(flags)));
}

value ocaml_gpiod_line_request_bulk_falling_edge_events_flags(value bulk, value consumer, value flags) {
	return Val_int(gpiod_line_request_bulk_falling_edge_events_flags(((struct gpiod_line_bulk *) ptr_of_val(bulk)), ((const char *) ptr_of_val(consumer)), Int_val(flags)));
}

value ocaml_gpiod_line_request_bulk_both_edges_events_flags(value bulk, value consumer, value flags) {
	return Val_int(gpiod_line_request_bulk_both_edges_events_flags(((struct gpiod_line_bulk *) ptr_of_val(bulk)), ((const char *) ptr_of_val(consumer)), Int_val(flags)));
}
...
value ocaml_gpiod_version_string() {
	return val_of_ptr((void *)gpiod_version_string());
}
